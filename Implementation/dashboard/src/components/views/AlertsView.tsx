    ...
    <div className="flex flex-col h-full">
      ...
      <header className="p-8 border-b border-slate-800/60 bg-slate-900/40 backdrop-blur-md sticky top-0 z-10">
        <div className="flex items-center gap-4">
          ...
          <div>
            <h1 className="text-3xl font-bold text-transparent bg-clip-text bg-gradient-to-r from-slate-100 to-slate-400 tracking-tight">Active Alerts & Investigations</h1>
            <p className="text-slate-400 text-sm mt-2 font-medium">Triage queue requiring analyst attention</p>
          </div>
        </div>
      </header>
